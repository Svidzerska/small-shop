...
const AddCategory: React.FC = (): JSX.Element => {
    ...
    const editNewCategoryInputField = (
    ...
    const doneNewCategory = (): void => {
        ...
        const secondElementCategory: Category | undefined =
            currentCategories.find((item) => item.name === value);

        if (
            value !== "" &&
            value !== "New Category" &&
            !secondElementCategory
        ) {
        ...
        return (
            <div className="addField">
                <div>
                    ...
                    <ConfirmButtons
                        className="addField__buttonResult"
